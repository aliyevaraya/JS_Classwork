...
let area=countries_data.sort((a,b)=>b.area-a.area).slice(0,11)
// console.log(area);


let top10population=countries_data.sort((a,b)=>b.population-a.population).slice(0,11)
// console.log(top10population);




let engLang=countries_data.filter((el,i)=>el.languages.includes('English'))
// console.log(engLang);

let region = countries_data.filter(el=>el.region===("Asia") || el.region===("Europe"))
// console.log(region.length);

let moreLan=countries_data.filter(el=> el.languages.length>1)
// console.log(moreLan);

// let nameCap=[]
// countries_data.forEach(el=>{el
// nameCap.push(el.name,el.capital)
// })
// console.log(nameCap);

console.log(countries_data.map(el=>`${el.name}, ${el.capital}`));

console.log(countries_data.reduce((sum,cur)=>sum+cur.population,0));